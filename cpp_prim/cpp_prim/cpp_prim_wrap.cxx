...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cpp_prim

#else
#  define SWIG_init    init_cpp_prim

#endif
#define SWIG_name    "_cpp_prim"
...
SWIGINTERN PyObject *_wrap_run_algorithm(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  swig_obj[0] = args;
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "run_algorithm" "', argument " "1"" of type '" "std::vector< std::vector< int,std::allocator< int > >,std::allocator< std::vector< int,std::allocator< int > > > >""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = run_algorithm(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "run_algorithm", _wrap_run_algorithm, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
